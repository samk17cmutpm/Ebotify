package com.eboltify.sales.ui.discount_create
...
class DiscountCreateActivity : BaseActivity() {

    companion object {
        fun start(context: Context) {
            val intent = Intent(context, DiscountCreateActivity::class.java)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        initToolBar(mToolbar, getString(R.string.discounts_create), R.drawable.ic_move_back)
